...
interface IdealKiloHesaplamaProps {
  image: string;
  title: string;
}

function IdealKiloHesaplama({image, title} : IdealKiloHesaplamaProps) {
  ...
  const weightHandleChange = (e : any) => {
    if (idealWeight) {
      setIdealWeight('');
    }
  ...
  const genderHandleChange = (e : any) => {
    if (idealWeight) {
      setIdealWeight('');
    }
