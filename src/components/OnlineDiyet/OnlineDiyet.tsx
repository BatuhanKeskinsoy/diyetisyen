...
interface IOnlineDiyetProps {
  generals: GeneralsTypes;
}

function OnlineDiyet({ generals }: IOnlineDiyetProps) {
  ...
  return (
    <div className="lg:pt-20 lg:pb-32 pt-12 pb-16 relative bg-black-900/70 overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-gray-200 flex flex-col gap-y-6">
        <span className="font-dancing tracking-wide lg:text-6xl text-5xl mb-2 block text-white">
          Online Diyet
        </span>
        <p className="lg:text-2xl text-xl">
          Siz de sağlıklı bir yaşam için adım atmak istiyor musunuz? Daha fazla
          zaman kaybetmeyin, sağlığınızı önemseyin ve hayalinizdeki forma
          ulaşmak için harekete geçin!
        </p>
        <p className="lg:text-2xl text-xl">
          Online diyet hizmeti veya diğer hizmetler hakkında daha fazla bilgi
          almak için aşağıdaki butonlardan bana ulaşabilirsiniz.
        </p>
        <address className="flex flex-wrap lg:flex-row flex-col gap-6 not-italic">
          ...
          >
            ...
            <span className="lg:text-2xl text-xl font-gemunu tracking-wide text-white">
