  ...
  return (
    <li className="list-none">
      ...
      >
        <Icon
          size={24}
          className=" group-hover:text-site cursor-pointer transition-all group-hover:scale-125"
        />
      </Link>
    </li>
  );
...
function AboutSocials({ socialUrl, iconName, socialName }: SocialsTypes) {
  const Icon = iconMappings[iconName];
  return (
    <li className="list-none">
      <Link
...
function FooterSocials({ socialUrl, iconName, socialName }: SocialsTypes) {
  const Icon = iconMappings[iconName];
  return (
    <li className="list-none">
      <Link
...
function ContactSocials({ socialUrl, iconName, socialName }: SocialsTypes) {
  const Icon = iconMappings[iconName];
  return (
    <li className="list-none">
      <Link
