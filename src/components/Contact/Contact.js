                        ...
                        <div className="flex flex-col justify-between items-center lg:items-start w-full gap-y-8">
                            <div className="flex lg:flex-row flex-col gap-y-4 items-center lg:justify-between justify-center lg:mb-12 w-full">
                                ...
                                <Link
                                    ...
                                    className='flex items-center justify-between rounded-xl px-6 gap-x-2 transition-all bg-green-500 hover:bg-green-400 text-white py-4'>
                                    <FaWhatsapp size={32} className='cursor-pointer transition-all' />
                                    <span className='text-2xl font-gemunu tracking-wide transition-all'>WhatsApp&#39;tan Ulaşın</span>
                                </Link>
                            </div>
                            ...
                            <address className='font-open not-italic tracking-wide text-sm flex lg:flex-row flex-col gap-x-8 lg:gap-y-0 gap-y-8 h-full w-full'>
                                <Link
                                    ...
                                    <BsSignpost2 size={80} className='text-customSecondary-400 group-hover:text-site mt-6 transition-all' />
                                    <span className='lg:text-xl text-lg p-4 text-gray-600'>{GeneralsData.address}</span>
                                    <div className="flex items-center gap-x-2 px-6 py-3 my-4 bg-white shadow-lg group-hover:bg-site group-hover:text-white font-gemunu text-lg lg:text-xl tracking-wider min-w-fit rounded-lg transition-all w-full justify-center mx-auto">Haritada Gör</div>
                                </Link>
                                ...
                                <Link
                                    ...
                                    className='flex flex-col items-center text-center justify-between gap-y-3 flex-1 w-full group overflow-hidden'>
                                    <BsTelephoneInbound size={80} className='text-customSecondary-400 group-hover:text-site mt-6 transition-all' />
                                    <span className='lg:text-xl text-lg p-4 text-gray-600'>{GeneralsData.phone}</span>
                                    <div className="flex items-center gap-x-2 px-6 py-3 my-4 bg-white shadow-lg group-hover:bg-site group-hover:text-white font-gemunu text-lg lg:text-xl tracking-wider min-w-fit rounded-lg transition-all w-full justify-center mx-auto">Hemen Ara</div>
                                </Link>
                                <Link
                                    href={`mailto:${GeneralsData.email}`}
                                    title={GeneralsData.email}
                                    className='flex flex-col items-center text-center justify-between gap-y-3 flex-1 w-full group overflow-hidden'>
                                    <BsEnvelopeAt size={80} className='text-customSecondary-400 group-hover:text-site mt-6 transition-all' />
                                    <span className='lg:text-xl text-lg p-4 text-gray-600 break-all'>{GeneralsData.email}</span>
                                    <div className="flex items-center gap-x-2 px-6 py-3 my-4 bg-white shadow-lg group-hover:bg-site group-hover:text-white font-gemunu text-lg lg:text-xl tracking-wider min-w-fit rounded-lg transition-all w-full justify-center mx-auto">Mail Gönder</div>
                                </Link>
                            </address>
